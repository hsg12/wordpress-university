...
var _Search = _interopRequireDefault(__webpack_require__(5));

var _MyNotes = _interopRequireDefault(__webpack_require__(6));
...
function () {
  ...
  _createClass(Search, [{
    ...
    value: function openOverlay() {
      ...
      this.searchField.val(''); // empty search field

      (0, _jquery.default)('#search-overlay__results').html(''); // empty results area

      /*
      setTimeout(function(){
          this.searchField.focus();
      }, 301); // 300 time for css transition (when opening the search page)
      */
      // Same as above
...
function new_map($el) {
  ...
  $markers.each(function () {
    add_marker((0, _jquery.default)(this), map);
  }); // center map
...
(0, _jquery.default)(document).ready(function () {
  (0, _jquery.default)('.acf-map').each(function () {
    // create map
    map = new_map((0, _jquery.default)(this));
  });
});
